    ...
    <main className="min-h-screen p-8">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="flex gap-4">
          ...
          <button className="px-6 py-3 bg-gray-200 dark:bg-gray-700 text-gray-900 dark:text-gray-100 rounded-lg font-medium hover:bg-gray-300 dark:hover:bg-gray-600 transition-colors">
            Workshop Feedback
          </button>
        </div>
      </div>
